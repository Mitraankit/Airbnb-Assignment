...
export default function Header() {
  return (
    <header className="flex justify-between items-center p-2 px-4 md:px-[220px]">
      ...
      <div className="hidden md:flex justify-center gap-2 text-sm border border-gray-300 rounded-full py-2 px-2 shadow-md shadow-gray-300">
        <div>Anywhere</div>
      ...
      <div className="flex gap-2 border border-gray-300 rounded-full py-1 px-3">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
